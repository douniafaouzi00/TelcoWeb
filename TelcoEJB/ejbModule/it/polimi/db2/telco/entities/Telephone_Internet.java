...
@Entity
@Table(name = "telephone_internet", schema = "telco_db")
public class Telephone_Internet implements Serializable {
	...
	public Telephone_Internet() {}
	
	public Telephone_Internet(Service id, int g, float f) {
		this.service_fk=id;
		this.giga=g;
		this.giga_fee=f;
	}
